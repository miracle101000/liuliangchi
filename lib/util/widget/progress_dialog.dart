    ...
    return SizedBox(
      ...
      child: Row(children: <Widget>[
        ...
        SizedBox(
          ...
          child: new CircularProgressIndicatorWidget(
            value: _progress / 100,
            strokeWidth: 6,
            backgroundColor: pColor.withOpacity(0.25),
            valueColor: new AlwaysStoppedAnimation<Color>(pColor),
          ),
        ),
          ...
          child: _progressDialogType == ProgressDialogType.Normal
              ...
              : Stack(
                  children: <Widget>[
                    ...
                    Positioned(
                      child: Text("${_progress.toString().split('.').first}%",
