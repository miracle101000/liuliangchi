...
import 'package:paixs_utils/widget/bg_page.dart';
...
mixin CupertinoRouteTransitionMixin<T> on p.PageRoute<T> {
  ...
  void didChangePrevious(Route<dynamic>? previousRoute) {
    ...
    if (_previousTitle == null) {
      ...
      _previousTitle!.value =
          previousTitleString == null ? '' : previousTitleString;
    }
  ...
  Duration get transitionDuration =>
      Duration(milliseconds: RouteState.routeAnimationTime);
...
class CupertinoPageRoute<T> extends p.PageRoute<T>
  ...
  CupertinoPageTransition({
    ...
    this.secondaryRouteAnimation,
        ...
        _secondaryPositionAnimation = (linearTransition
            ...
            .drive(
                RouteState.isFromDown ? _kMiddleLeftTween1 : _kMiddleLeftTween),
          ...
          return ScaleTransition(
            ...
            child: SlideTransition(
              position: (linearTransition
                ...
                Tween(
                  begin: Offset(0, 0),
                  end: Offset(RouteState.isFromDown ? 0 : -0.15,
                      RouteState.isFromDown ? -0.1 : 0),
                ),
              ),
              child: Stack(
                children: [
                  ...
                  SlideTransition(
                    position: (linearTransition
                      ...
                      Tween(
                        begin:
                            RouteState.isFromDown ? Offset(0, 1) : Offset(1, 0),
                        end: Offset(0, 0),
                      ),
                    ),
                    child: RouteState.radiusValue == 0.0
                        ? RouteState.isRecycle
                            ? Stack(
                                children: [
                                  Visibility(
                                    visible:
                                        secondaryRouteAnimation!.value <= 0.0,
                                    child: child,
                                    maintainState: true,
                                  ),
                                  Visibility(
                                    ...
                                    child: Container(
                                      ...
                                      child: Opacity(
                                        ...
                                        child: RouteState.recycleStr == null
                                            ? CupertinoActivityIndicator()
                                            : MyText(RouteState.recycleStr),
                                      ),
                                    ),
                                  ),
                                ],
                        ...
                        : ClipRRect(
                            borderRadius:
                                BorderRadius.circular(RouteState.radiusValue),
                            child: child,
                          ),
                  ),
                ],
                        ...
                        FadeTransition(
                          opacity: (linearTransition
                                  ...
                                  : CurvedAnimation(
                                      ...
                                      curve: RouteState.animationCurve,
                                      reverseCurve:
                                          RouteState.animationReverseCurve,
                                    ))!
                              .drive(Tween(begin: 0.0, end: 0.5)),
                          child: Container(color: Colors.black),
                        ),
                              ...
                              child: Align(
                                ...
                                widthFactor: ((linearTransition
                                            ...
                                            : CurvedAnimation(
                                                parent: primaryRouteAnimation!,
                                                curve:
                                                    RouteState.animationCurve,
                                                reverseCurve: RouteState
  ...
  void dragEnd(double velocity) {
    ...
    if (animateForward) {
      ...
      controller.animateTo(1.0,
          duration: Duration(milliseconds: RouteState.routeAnimationTime),
          curve: RouteState.animationCurve);
    } else {
      navigator.pop();
...
class RouteState {
  ...
  ///标题箭头从下往下的动画时间 200
  static int fromToDownAnimationTime =
      (200 * (animationTime / 400)).toInt() + 50;

  ///标题箭头从右向左动画时间 150
  static int rightToLeftAnimationTime =
      (150 * (animationTime / 400)).toInt() + 50;

  ///从下到下列出动画时间 150
  static int listFromToDownAnimationTime =
      (150 * (animationTime / 400)).toInt() + 50;
  // static int listFromToDownAnimationTime = 150;

  ///从右向左列出动画时间 100
  static int listRightToLeftAnimationTime =
      (100 * (animationTime / 400)).toInt() + 50;
  // static int listRightToLeftAnimationTime = 100;

  ///列出垂直动画时间 200
  static int listVerticalAnimationTime =
      (200 * (animationTime / 400)).toInt() + 50;
