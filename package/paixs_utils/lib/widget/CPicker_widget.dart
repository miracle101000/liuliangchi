          ...
          Positioned.fill(
            child: _CupertinoPickerSemantics(
              ...
              child: ListWheelScrollView.useDelegate(
                ...
                physics:
                    FixedExtentScrollPhysics(parent: MyBouncingScrollPhysics()),
...
class _RenderCupertinoPickerSemantics extends RenderProxyBox {
  ...
  FixedExtentScrollController? get gcontroller => _controller;
  FixedExtentScrollController? _controller;
  ...
  void _handleIncrease() {
    gcontroller!.jumpToItem(_currentIndex + 1);
  }
  ...
  void _handleScrollUpdate() {
    if (gcontroller!.selectedItem == _currentIndex) return;
    _currentIndex = gcontroller!.selectedItem;
    markNeedsSemanticsUpdate();
  }
