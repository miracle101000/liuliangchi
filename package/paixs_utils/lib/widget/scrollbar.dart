...
class _CupertinoScrollbarWidgetState
    extends RawScrollbarState<CupertinoScrollbarWidget> {
  ...
  void updateScrollbarPainter() {
    scrollbarPainter
      ..color =
          CupertinoDynamicColor.resolve(Colors.black.withOpacity(0.1), context)
